                                ...
                                <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                    ...
                                    <div class="wsus__pro_det_vendor">
                                        <div class="row">
                                            ...
                                            <div class="mt-4 col-xl-6 col-xxl-7 col-md-6 mt-md-0">
        ...
        <div class="modal-body">
          <form action="" class="message_modal">
            ...
            <div class="form-group">
                ...
                <textarea name="message" class="mt-2 form-control message-box"></textarea>
                <input type="hidden" name="receiver_id" value="{{ $product->vendor->user_id }}">
              </div>

              <button type="submit" class="mt-4 btn add_cart send-button">Send</button>
                    ...
                    <div class="col-md-3">
                        <div class="wsus__product_item">
                            <a class="wsus__pro_link" href="{{route('product-detail', $relatedProduct->slug)}}">
                                ...
                                <img src="
                                 @if(isset($relatedProduct->productImageGalleries[0]->image))
                            ...
                            <div class="card-body">
                                <h5 class="card-title">{{ limitText($relatedProduct->name,30) }}</h5>
                                <p class="card-text">{{ limitText($relatedProduct->short_description,100) }}</p>
                                <a href="{{ route('product-detail', $relatedProduct->slug) }}" class="btn btn-primary">View Details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            $('.message_modal').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.message-box').val('');
                        $('.modal-body').append(`<div class="mt-2 alert alert-success"><a href="{{ route('user.messages.index') }}" class="text-primary">Click here</a> for go to messenger.</div>`)
