...
@section('content')
    ...
    <section id="wsus__product_page">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    @if(@$product_page_banner->banner_four ->status == 1)
                    <div class="wsus__pro_page_bammer">
                        <img src="{{asset(@$product_page_banner->banner_four->banner_image)}}" alt="banner" class="img-fluid w-100">
                        <div class="wsus__pro_page_bammer_text">
                            <div class="wsus__pro_page_bammer_text_center">
                                <p>{{@$product_page_banner->banner_four->product_page_banner_text_p}} <span>{{@$product_page_banner->banner_four->product_page_banner_text_span_p}}</span></p>
                                <h5>{{@$product_page_banner->banner_four->product_page_banner_text_h5}}</h5>
                                <h3>{{@$product_page_banner->banner_four->product_page_banner_text_h3}}</h3>
                                <a href="{{@$product_page_banner->banner_four->banner_url}}" class="add_cart">Discover Now</a>
                            </div>
                        </div>
                    </div>
                    @endif
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <ul class="wsus__single_pro_icon">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        @endforeach
                                                        <input class="" name="qty" type="hidden" min="1" max="100" value="1" />
                                                        <button class="mr-2 add_cart_two" type="submit">add to cart</button>
                                                    </form>
